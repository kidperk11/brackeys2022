...
namespace NWH.DWP2.ShipController
{
    ...
    public class ShipInputHandler
    {
        ...
        public bool ToggleBoatStatus
        {
            get { return states.toggleBoatStatus; }
            set { states.toggleBoatStatus = value; }
        }
        ...
        public void Update()
        {
            ...
            ToggleBoatStatus |= InputProvider.CombinedInput<ShipInputProvider>(i => i.ToggleBoatStatus());
