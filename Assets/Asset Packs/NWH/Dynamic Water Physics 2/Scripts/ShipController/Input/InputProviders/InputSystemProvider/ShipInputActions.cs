...
//     version 1.3.0
//     from Assets/Asset Packs/NWH/Dynamic Water Physics 2/Scripts/ShipController/Input/InputProviders/InputSystemProvider/ShipInputActions.inputactions
//
...
namespace NWH.DWP2.ShipController
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""ToggleBoatStatus"",
                    ""type"": ""Button"",
                    ""id"": ""27d007ae-63b6-42c4-94b3-a6542dd9ddb1"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""cf077b21-54d7-4ba5-8f58-699d95f11088"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ToggleBoatStatus"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
            ...
            m_ShipControls_ToggleBoatStatus = m_ShipControls.FindAction("ToggleBoatStatus", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_ShipControls_ToggleBoatStatus;
        public struct ShipControlsActions
        {
            ...
            public InputAction @ToggleBoatStatus => m_Wrapper.m_ShipControls_ToggleBoatStatus;
            ...
            public void SetCallbacks(IShipControlsActions instance)
            {
                if (m_Wrapper.m_ShipControlsActionsCallbackInterface != null)
                {
                    ...
                    @ToggleBoatStatus.started -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnToggleBoatStatus;
                    @ToggleBoatStatus.performed -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnToggleBoatStatus;
                    @ToggleBoatStatus.canceled -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnToggleBoatStatus;
                }
                ...
                if (instance != null)
                {
                    ...
                    @ToggleBoatStatus.started += instance.OnToggleBoatStatus;
                    @ToggleBoatStatus.performed += instance.OnToggleBoatStatus;
                    @ToggleBoatStatus.canceled += instance.OnToggleBoatStatus;
                }
            }
        }
        ...
        public interface IShipControlsActions
        {
            ...
            void OnToggleBoatStatus(InputAction.CallbackContext context);
        }
    }
}
